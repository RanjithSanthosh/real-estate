...
//   title: string; 
//   links: string[];
//   category: 'city' | 'propertyType' | 'status' | null;
// }) => {
...
//     // Handle "All..." cases (clear filter)
//     if (label.toLowerCase().includes('all ')) {
//       // Keep other existing params if needed, but clear this category
//       // For simplicity, we'll just redirect to /search with no params
//       router.push('/search');
//       return;
//     }

//     // Map labels to query params
//     switch (category) {
//       case 'city':
//         params.set('city', label);
//         break;
//       case 'propertyType':
//         // Normalize property type to match your data format
//         let propType = label;
//         if (label === "Apartment For Sale") propType = "Apartments";
//         if (label === "Villas & Row Houses") propType = "Villa";
//         params.set('propertyType', propType);
//         break;
//       case 'status':
//         // Normalize status values
//         let status = label;
//         if (label === "New Properties") status = "Under Construction"; // Adjust based on your data
//         if (label === "Under Construction Properties") status = "Under Construction";
//         if (label === "Ready to Move Properties") status = "Ready to Move";
//         if (label === "Resale Properties") status = "Resale";
...
//                 className="text-left hover:text-green-600 hover:underline transition-colors duration-300 w-full text-left"
//               >
//                 {link}
//               </button>
//             ) : (
