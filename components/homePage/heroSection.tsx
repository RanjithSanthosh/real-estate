...
//   User
// } from "lucide-react";
// import heroImage from "./assets/Hero.png"; // ✅ 1. IMPORT THE IMAGE HERE (adjust path if needed)
// import eteImage from "./assets/ETEproperty.png"; // ✅ 1. IMPORT THE IMAGE HERE (adjust path if needed)
...
//   return (
//     <div className="bg-white">
//       {/* The <main> tag here is redundant since HomePage has one. Let's use a <div> or fragment. */}
//       <div>
//         {/* Hero Section */}
//         <div className="relative h-[70vh] min-h-[600px] lg:h-screen">
//           {/* Background Image */}
...
//                   <button className="p-3 bg-green-500 text-white rounded-full hover:bg-green-600 transition-colors"><SlidersHorizontal size={20} /></button>
//                   <button className="p-3 bg-green-500 text-white rounded-full hover:bg-green-600 transition-colors"><Settings2 size={20} /></button>
//                   <button onClick={onSearchClick} className="p-3 bg-green-500 text-white rounded-full hover:bg-green-600 transition-colors">
//                     <Search size={20} />
//                   </button>
//               </div>
//           </div>
...
export default function HeroSection({ onSearchClick, searchTerm, onSearchChange }: HeroSectionProps) {
  return (
    <div className="bg-white">
      <Hero
