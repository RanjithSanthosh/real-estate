...
//           <p className="text-xl text-gray-200">Meet our family.</p>
...
export default function AboutHeroSection({
  ...
  const { openLoginModal, openOfferModal, isOfferModalOpen, closeOfferModal ,openConsultationModal } = useUI();
  ...
  return (
    <div className="relative h-[55vh] min-h-[400px] lg:min-h-[500px] overflow-hidden rounded-b-[40px] shadow-lg">
      ...
      <header className="absolute top-0 left-0 right-0 z-30">
        ...
        >
          ...
          <div className="hidden lg:flex items-center gap-8 font-medium">
            ...
            <motion.div whileHover={{ y: -2 }}><Link href="/about" className="bg-white rounded-3xl text-gray-700 px-4 py-2 border border-transparent">About</Link></motion.div>
          ...
          <div className="flex items-center gap-4 ">
            <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} onClick={openConsultationModal} className="hidden sm:flex items-center gap-2 border backdrop-blur-sm px-4 py-2 rounded-3xl font-medium">
              <Phone size={16} /> Call Us{" "}
          ...
          <AnimatePresence>
            {isMenuOpen && (
              ...
              >
                ...
                <Link href="/about" className="font-semibold text-green-600">About</Link>
      ...
      <div className="relative z-20 flex flex-col justify-center h-full text-white px-6 md:px-12">
        ...
        >
          <motion.h1 variants={itemVariants} className="text-5xl md:text-6xl font-bold mb-2">About Us</motion.h1>
          <motion.p variants={itemVariants} className="text-xl text-gray-200">Meet our family.</motion.p>
        </motion.div>
      </div>
