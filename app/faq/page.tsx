...
//                         <h1 className="text-4xl md:text-5xl font-serif text-gray-900 font-bold mb-12">Frequently Asked Questions</h1>
...
import DetailedFooter from '@/components/aboutPage/DetailedFooter';
import SiteMapFooter from '@/components/homePage/SiteMapFooter';
import { faqsData } from '../data/faqs'; // ✅ Removed unused blog data
import Link from 'next/link';
import {
  Accordion,
  AccordionContent,
...
// --- LatestBlogCard function removed from here ---
