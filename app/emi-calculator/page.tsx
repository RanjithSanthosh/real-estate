...
// function LatestBlogCard({ blog }: { blog: Blog }) {
//     return (
//         <Link href={`/blogs/${blog.id}`} className="flex items-center gap-4 group">
//             <div className="relative w-20 h-20 rounded-lg overflow-hidden flex-shrink-0">
//                 <Image 
//                     src={blog.image} 
//                     alt={blog.title} 
...
// import EmiCalculatorClient from './EmiCalculatorClient'; // ✅ Import the new client component
// import Link from 'next/link';
...
//                 {/* The EmiCalculatorClient component contains all the interactive UI 
//                   and receives the blog data as a prop.
//                 */}
//                 <EmiCalculatorClient latestBlogs={latestBlogs} />
//             </main>
//             <SiteMapFooter />
//             <DetailedFooter />
//         </div>
