...
//                     {/* Tags are not in the minimal fetch, so we default */}
...
// export default function EmiCalculatorClient({ latestBlogs }: { latestBlogs: PrismicBlog[] }) {
...
//                         {/* ✅ This now maps over the data from the Prismic API */}
...
import React, { useState, useMemo } from 'react';
import { PrismicBlog } from '@/app/data/prismic'; // ✅ Still needed for prop type
import { ChevronDown, ChevronUp } from 'lucide-react';
import LatestBlogsSidebar from '@/components/shared/LatestBlogsSidebar'; // ✅ Import new component
...
export default function EmiCalculatorClient({ latestBlogs }: { latestBlogs: PrismicBlog[] }) {
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            {/* ✅ Sidebar: Replaced with new centralized component */}
