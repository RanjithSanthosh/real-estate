...
//      price: 50000000, // ✅ ADD NUMERIC PRICE (5.0 Cr)
...
export type Developer = {
  id: string; // This will be a "pseudo-ID" from the string
  name: string;
  logo?: string;
  totalProjects: number;
  ongoingProjects: number;
...
// ❌ REMOVE THE STATIC 'developersData' ARRAY
...
  tag?: { text: string; color: 'green' | 'yellow' | 'blue' };
  featured: boolean;
  // ✅ CHANGED: React.ElementType -> string
...
// ❌ REMOVE THE STATIC 'propertiesData' ARRAY
// This is what was causing your previous 'slice' error