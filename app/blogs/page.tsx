...
import { ArrowLeft, ArrowRight, Search, Palmtree, CalendarDays } from 'lucide-react';
...
export default function BlogListingPage() {
    ...
    const filteredBlogs = useMemo(() => {
        ...
        return blogsData.filter(blog => 
            ...
            blog.shortDescription.toLowerCase().includes(lowercasedSearchTerm) ||
            blog.author.toLowerCase().includes(lowercasedSearchTerm)
        );
    }, [searchTerm]);
            ...
            <main className="container mx-auto max-w-5xl px-4 py-12 md:py-16">
                ...
                <div className="relative mb-12 max-w-2xl mx-auto">
                    <input 
                        ...
                        className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-full focus:ring-2 focus:ring-green-500 outline-none"
                    />
                ...
                {currentBlogs.length > 0 ? (
                    ...
                    <div className="text-center text-gray-600 py-16">
                        ...
                        <p className="mt-2">Try adjusting your search. We're always adding new content!</p>
                    </div>
                )}
