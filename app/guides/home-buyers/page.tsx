...
import DetailedFooter from '@/components/aboutPage/DetailedFooter';
import SiteMapFooter from '@/components/homePage/SiteMapFooter';
import { searchBlogs } from '@/services/api'; // ✅ Import your API function
import { PrismicBlog } from '@/app/data/prismic'; // ✅ Import the Prismic type
import GuideClientPage from './GuideClientPage'; // ✅ Import the new client component
import Link from 'next/link';

// This is now a Server Component
export default async function HomeBuyersGuidePage() {
    
    // ✅ Fetch the 5 most recent blogs from the API on the server
    ...
    return (
        <div className="bg-white">
            ...
            <main className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 md:py-24">
                ...
                {/* The GuideClientPage component contains all the UI 
                  and receives the blog data as a prop.
                */}
                <GuideClientPage latestBlogs={latestBlogs} />
            </main>
            <SiteMapFooter />
            <DetailedFooter />
        </div>
