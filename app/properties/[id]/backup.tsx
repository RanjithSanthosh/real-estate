...
// At the top of your app/properties/[id]/page.tsx
...
// propertiesdetailes.tsx:
// // app/properties/[id]/PropertyDetailClient.tsx

// "use client"; // ✅ "use client" directive is here
...
//   Property,
//   Developer,
//   propertiesData, // For related properties
// } from "../../data/properties";
// import Navbar from "@/components/shared/Navbar";
// import {
//   Heart,
...
// // Interface for the props we are receiving from the server component
// interface PropertyDetailClientProps {
//   property: Property;
//   developer?: Developer;
// }

// // The main component now accepts `property` and `developer` as props
// export default function PropertyDetailClient({
//   property,
//   developer,
// }: PropertyDetailClientProps) {
//   // ❌ We no longer need to find the property here, it's passed in as a prop
//   // const resolvedParams = use(params);
//   // const property = propertiesData.find( ... );
...
//         <RelatedProperties currentProperty={property} />
//       </main>
//       {/* You might want to add your footers back here if they were removed */}
//     </div>
//   );
// }

// // --- ALL YOUR OTHER SUB-COMPONENTS GO HERE ---
// // (PropertyHeader, PropertyTabs, LocationMap, RelatedProperties, etc.)
// // Copy and paste ALL the remaining functions from your original file below this line.
// // No changes are needed inside them.
...
//   const handleShare = async () => {
//     try {
//       const shareDescription = `🏠 ${property.name} in ${property.location} | ${
//         property.priceRange
//       } | ${property.specs.map((spec) => spec.text).join(" • ")}`;
//       const shareData = {
//         title: `${property.name} - ${property.developer}`,
//         text: shareDescription,
//         url: window.location.href,
...
//       if (err instanceof Error && err.name !== "AbortError") {
//         console.error("Share failed:", err);
//         const shareDescription = `🏠 ${property.name} in ${
//           property.location
//         } | ${property.priceRange} | ${property.specs
//           .map((spec) => spec.text)
//           .join(" • ")}`;
//         await handleClipboardFallback({
//           title: `${property.name} - ${property.developer}`,
