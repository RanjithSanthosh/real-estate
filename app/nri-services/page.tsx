                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="space-y-10">
                            {nriServicesData.map((section, index) => (
                                <div key={index}>
                                    <h2 className="text-2xl font-serif font-bold text-gray-800 mb-4">{section.title}</h2>
                        ...
                        <div className="mt-12 pt-8 border-t">
                         ...
                         <button className="w-full bg-black text-white py-4 px-6 mt-12 rounded-lg font-bold text-lg hover:bg-gray-800 transition-colors flex items-center justify-center gap-3">
